<template>
    <div class="pre-loader" ref="preLoader">
        <div class="pre-loader-container">
            <div class="pre-loader-header">
                ...
                <div class="header">
                    <h1 data-text="coding">coding </h1>
                    <h1 data-text="skin">skin</h1>
                    <div class="header-wrapper"></div>
                </div>
                <div class="header">
                    <h1>with a</h1>
                ...
                <div class="header">
                    <h1 data-text="design">design </h1>
                    <h1 data-text="soul">soul</h1>
                    <div class="header-wrapper"></div>
                </div>
                <div class="header">
                    <h1> in, the</h1>
                ...
                <div class="header">
                    <h1 data-text="digital">digital </h1>
                    <h1 data-text=" era">era</h1>
                    <div class="header-wrapper"></div>
                </div>
            </div>

            <div class="pre-loader-btn" ref="preLoaderBtn" @click="revealSite">
                <div class="btn">
                    click anywhere
